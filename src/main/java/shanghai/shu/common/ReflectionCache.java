...
public class ReflectionCache {
    private static WeakHashMap<String,Class<?>> CLASS_CACHE=new WeakHashMap<String, Class<?>>();
    private static WeakHashMap<String,Method> METHOD_CACHE=new WeakHashMap<String, Method>();
    private static WeakHashMap<String,MethodAccess> METHOD_ACCESS_CACHE=new WeakHashMap<String, MethodAccess>();
    private static WeakHashMap<String,Integer> METHOD_INDEX_CACHE=new WeakHashMap<String, Integer>();
    ...
    public static String join(Class<?> classType,String methodName,Class<?>[] parametersType){
